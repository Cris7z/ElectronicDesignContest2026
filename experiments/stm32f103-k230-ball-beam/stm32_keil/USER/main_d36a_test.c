 ...
 * STM32 USART1_RX = PA10 receives it.  This program drives D36A channel 1:
...
/* Read and validate a complete K230 text frame collected by USART1 IRQ. */
...
static void BallController_Step(void)
{
     ...
     * the complete K230 TX -> PA10 -> USART parser -> D36A path. */
...
int main(void)
{
    ...
    printf("Ball control ready: wait K230 UART1 on PA10\r\n");
