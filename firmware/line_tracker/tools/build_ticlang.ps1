...
# The line-tracker BSP is self-contained in this directory after migration.
...
if ($AppSource -ne 'app\main.c') {
    throw "Only the production pure-line-tracker entry point is retained: app\\main.c"
}
$sources = @(
