...
#define CONTROL_FIRMWARE_VERSION       "BALL_BEAM_F103_V8_Q3_K4_SEQUENCE_PA10_RCT6"
...
#define Q3_REVERSAL_STOP_SPEED_MM_S     5.0f
...
static void Q3TaskUpdate(s32 position_mm, u8 new_camera_sample)
{
    ...
    {
        if(position_mm <= Q3_NEG_BRAKE_POINT_MM)
        {
            ...
            s_q3_final_stable_frames = 0U;
            s_q3_drive_assist_active = 0U;
            printf("Q3_NEG_BRAKE_POINT,pos_mm=%ld,vel_x10=%ld,elapsed=%lu,reverse_mm=%ld\r\n",
                   position_mm, s_q3_neg_hit_velocity_x10,
                   s_q3_neg_hit_elapsed_ms, s_ball_target_mm);
        }
    }

    if((s_q3_state == Q3_BRAKE_RETURN_NEG) && (new_camera_sample != 0U) &&
       (s_velocity_mm_s >= Q3_REVERSAL_STOP_SPEED_MM_S))
    {
