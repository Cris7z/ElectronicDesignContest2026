...
#define CONTROL_FIRMWARE_VERSION       "BALL_BEAM_F103_V12_Q3_PROPORTIONAL_BRAKE_PA10_RCT6"
...
#define Q3_NEG_OUTPUT_LIMIT_COUNTS     60.0f
#define Q3_NEG_NEAR_ZONE_MM             50L
#define Q3_NEG_NEAR_EXTRA_KD           0.65f
...
static void Q3TaskUpdate(s32 position_mm, u8 new_camera_sample)
{
    ...
    if((s_q3_state == Q3_GO_NEG_50) && (new_camera_sample != 0U))
    {
         ...
         * deceleration.  V12 caps the reverse command at 60 counts, so the
         * predictor scales that estimate to 480 mm/s^2.  Inertia,
