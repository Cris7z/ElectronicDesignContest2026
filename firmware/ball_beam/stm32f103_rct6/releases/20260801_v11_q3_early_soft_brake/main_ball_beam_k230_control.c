...
#define CONTROL_FIRMWARE_VERSION       "BALL_BEAM_F103_V11_Q3_EARLY_SOFT_BRAKE_PA10_RCT6"
...
static void Q3TaskUpdate(s32 position_mm, u8 new_camera_sample)
{
    ...
    if((s_q3_state == Q3_GO_NEG_50) && (new_camera_sample != 0U))
    {
         ...
         * deceleration.  V11 softens the reverse command to 75 counts, so
         * the predictor scales that estimate to 600 mm/s^2.  Inertia,
