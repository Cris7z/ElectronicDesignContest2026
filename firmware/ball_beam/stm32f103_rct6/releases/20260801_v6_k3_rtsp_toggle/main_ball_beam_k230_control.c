...
#define CONTROL_FIRMWARE_VERSION       "BALL_BEAM_F103_V6_K3_RTSP_TOGGLE_PA10_RCT6"
...
static void PrintStatus(void)
{
    ...
    s_last_log_ms = g_ms;
    printf("BALL,t=%lu,state=%u,raw_mm=%ld,filt_x10=%ld,conf=%u,vel_x10=%ld,target=%ld,count=%ld,rpm_x100=%ld,brake_x10=%ld,age=%lu,valid=%lu,invalid=%lu,parse=%lu,peak_mm=%ld,peak_inner=%ld\r\n",
