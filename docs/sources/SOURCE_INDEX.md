...
| S-D36-04 | D36A 问题排查和检测方法 | PDF，V1.0，2024-11-23 | `D:\BaiduNetdiskDownload\【WHEELTEC】D36A步进电机驱动附送资料\...\1.用户手册与使用教程\D36A驱动问题排查和检测方法.pdf` | 已阅读 | [`../hardware/D36A_STEPPER_DRIVER.md`](../hardware/D36A_STEPPER_DRIVER.md) | 电源→芯片→控制引脚的安全排查顺序。 |
| S-D36-05 | D36A 电阻调节电流参数表 | XLSX | `D:\BaiduNetdiskDownload\【WHEELTEC】D36A步进电机驱动附送资料\...\1.用户手册与使用教程\电阻调节电流参数表.xlsx` | 已阅读 | [`../hardware/D36A_STEPPER_DRIVER.md`](../hardware/D36A_STEPPER_DRIVER.md) | 电流计算值与 D36A 手册的八档拨码表一致。 |
